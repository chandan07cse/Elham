...
<form action="/user/store" method="POST"  role="form" enctype="multipart/form-data">
    ...
    <div class="form-group col-sm-12 <?php echo e(@$errors->username ? 'has-error' : ''); ?>">
        ...
        <input class="form-control" name="username" type="text" <?php echo e(@$errors->username ? 'autofocus' : ''); ?> placeholder="username" value="<?php echo e(@$oldValue->username); ?>">
    ...
    <div class="form-group col-sm-12 <?php echo e(@$errors->email ? 'has-error' : ''); ?>">
        ...
        <input class="form-control" name="email" type="email" <?php echo e(@$errors->email ? 'autofocus':''); ?> placeholder="email" value="<?php echo e(@$oldValue->email); ?>">
        <?php if(@$errors->email): ?>
            <ul>
    ...
    <div class="form-group col-sm-12 <?php echo e(@$errors->password ? 'has-error' : ''); ?>">
        ...
        <input class="form-control" name="password" <?php echo e(@$errors->password ? 'autofocus':''); ?> type="password" value="<?php echo e(@$oldValue->password); ?>" placeholder="password">
